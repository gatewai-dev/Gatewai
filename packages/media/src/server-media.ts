...
import type { MediaService, IPixiProcessor, FileData } from "@gatewai/types";
import {
    Application,
    Assets,
    BlurFilter,
...
class BackendPixiService extends BasePixiService implements IPixiProcessor {
    ...
    // @ts-ignore - The types from pixi-types-stub might conflict slightly with @pixi/node but implementation is correct
