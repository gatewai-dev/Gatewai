/*
  ...
  - The values [Lottie,Json] on the enum `DataType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "DataType_new" AS ENUM ('Text', 'Number', 'Boolean', 'Image', 'Video', 'Audio', 'SVG', 'Caption');
