...
INSERT INTO "new_node_template" ("category", "createdAt", "defaultConfig", "description", "displayName", "id", "processEnvironment", "showInQuickAccess", "subcategory", "tokenPrice", "type", "updatedAt", "variableInputs", "variableOutputs") SELECT "category", "createdAt", "defaultConfig", "description", "displayName", "id", "processEnvironment", "showInQuickAccess", "subcategory", "tokenPrice", "type", "updatedAt", "variableInputs", "variableOutputs" FROM "node_template";
