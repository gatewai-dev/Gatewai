/*
  ...
  - Added the required column `processEnvironment` to the `node` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_node" ("canvasId", "createdAt", "data", "deletable", "draggable", "fileData", "height", "id", "name", "selectable", "templateId", "type", "updatedAt", "visible", "width", "zIndex") SELECT "canvasId", "createdAt", "data", "deletable", "draggable", "fileData", "height", "id", "name", "selectable", "templateId", "type", "updatedAt", "visible", "width", "zIndex" FROM "node";
DROP TABLE "node";
