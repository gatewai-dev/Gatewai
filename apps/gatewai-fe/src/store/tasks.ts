import { createAsyncThunk, createDraftSafeSelector, createEntityAdapter, createSlice, type PayloadAction } from '@reduxjs/toolkit';
...
export const getBatchDetails = createAsyncThunk<BatchDetailsRPC, BatchDetailsRPCParams>(
  'tasks/getBatchDetails',
  async (params) => {
...
export const getInitialBatches = createAsyncThunk<BatchDetailsRPC, { canvasId: string }>(
  'tasks/getInitialBatches',
  async ({ canvasId }) => {
