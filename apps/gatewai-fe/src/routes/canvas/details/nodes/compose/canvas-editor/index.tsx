        ...
        {layers.map((layer) => (
          <li
            ...
            style={{
              cursor: "pointer",
              padding: "4px",
              background: layer.id === useEditor().selectedId ? "#ddd" : "transparent",
            }}
          >
            {layer.type.charAt(0).toUpperCase() + layer.type.slice(1)} - {layer.id.slice(0, 6)}
          </li>
        ))}
      </ul>
    </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        <label>
          ...
          <input
            ...
            onChange={(e) => updateLayer({ x: parseFloat(e.target.value) || 0 })}
          />
        </label>
        <label>
          Y:{" "}
          <input
            ...
            onChange={(e) => updateLayer({ y: parseFloat(e.target.value) || 0 })}
          />
        </label>
        <label>
          Width:{" "}
          <input
            ...
            onChange={(e) => {
              const newWidth = parseFloat(e.target.value) || selectedLayer.width;
        ...
        <label>
          ...
          <input
            ...
            onChange={(e) => {
              const newHeight = parseFloat(e.target.value) || selectedLayer.height;
