...
import metadata, { CropNodeConfigSchema } from "../metadata.js";

@injectable()
class CropProcessor implements NodeProcessor {
    constructor(
...
export default defineNode(metadata, { backendProcessor: CropProcessor });
